...
public class OrderItemServiceImpl implements OrderItemService {
    ...
    public OrderItem getByOrderAndItem(Order order, Item item) {
        List<OrderItem> orderItems = orderItemRepository.findByOrderAndItem(order, item);
    ...
    public void createOrUpdateOrderItem(int orderId, int itemId, int quantity){
        ...
        OrderItem orderItem = getByOrderAndItem(order, item);
        if (orderItem != null) {
